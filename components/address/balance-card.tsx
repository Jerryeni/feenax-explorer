  ...
  return (
    <Card className="p-6 w-full">
      ...
      <div className="space-y-6">
        <div>
          <div className="text-sm text-gray-500 mb-2">FNX BALANCE</div>
          <div className="flex items-center gap-2">
            ...
            />
            <span className="text-lg mr-1">{balance.fnx} FNX</span>
          </div>
        </div>

        <div>
          <div className="text-sm text-gray-500 mb-2 ">FNX VALUE</div>
            ...
            {isDropdownOpen && (
              <div className="absolute top-full left-0 right-0 mt-2 bg-white rounded-lg border shadow-lg z-50">
                <div className="p-4">
                  ...
                  <div className="font-medium mb-2">FNX-20 Tokens ({balance.tokens.length})</div>
